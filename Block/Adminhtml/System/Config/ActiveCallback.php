...
class ActiveCallback extends FormField
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $this->addData(
            [
                ...
                'html_id' => "active_callback_transaction_button",
                'ajax_url' => $this->_urlBuilder->getUrl('gbprimepay/system_config/activeCallback'),
            ]
        );
