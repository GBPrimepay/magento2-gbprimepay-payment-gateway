...
class RequestBeforeDirect implements ObserverInterface
{
...
public function __construct(
    ...
    $customer_id = $order->getQuote()->getCustomerId();
        ...
        $itemresponseurl = $this->_config->getresponseUrl('response_direct');
        $itembackgroundurl = $this->_config->getresponseUrl('background_direct');
