...
require(
    ...
    'use strict';
        ...
        ToSelect.prototype = {
            ...
            var get_amount = $("input[name='payment[transaction_amt]']").val();
            var get_bankimg = window.gbprimepay.imgpathInstallment;
            
            var varBank = $("select[name='payment[issuers_bankcode]'] option").filter(':selected').val();
            var varSelected = $("select[name='payment[issuers_term]'] option").filter(':selected').val();
...
infotxt += '</td>';
infotxt += '<td cellpadding="0" cellspacing="0" height="50%" width="100%" style="border: none !important;text-align: left; vertical-align: bottom;padding: 0;"><span style="border: none !important;margin:0;padding:0 0 0 5px;line-height: 1 !important;"><strong>x'+varSelected+'</strong></span></td>';
infotxt += '</tr>';
infotxt += '<tr cellpadding="0" cellspacing="0" height="100%" width="100%" style="border: none !important;padding: 0;">';
infotxt += '<td cellpadding="0" cellspacing="0" height="50%" width="100%" style="border: none !important;width:25%;min-width170px;text-align: left; vertical-align: top;padding: 0 0 5px 0;"><span style="border: none !important;margin:0;padding:0 0 0 5px;line-height: 1 !important;">payments</span></td>';
infotxt += '</tr>';
infotxt += '<tr cellpadding="0" cellspacing="0" height="100%" width="100%" style="border: none !important;padding: 0;">';
...
infotxt += '</table>';
            ...
            if(varSelected){
              $('#gbprimepay_installment_issuers_info').html(infotxt);
            }else{
              $('#gbprimepay_installment_issuers_info').html('');
            }
