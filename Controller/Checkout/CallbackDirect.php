...
class Callbackdirect extends \GBPrimePay\Payments\Controller\Checkout
{
    ...
    public function execute()
    {
        try {
            if ($this->_config->getEnvironment() === 'prelive') {
                ...
                if (($this->_config->getTestPublicKey() === true) && ($this->_config->getTestSecretKey() === true)) {
                }else{
                  return false;
                }
                ...
                if (($this->_config->getLivePublicKey() === true) && ($this->_config->getLiveSecretKey() === true)) {
                }else{
                  return false;
                }
