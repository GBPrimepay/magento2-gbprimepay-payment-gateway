...
class EventsBeforeBarcode extends \GBPrimePay\Payments\Controller\Checkout
  {
      ...
      {
          try {
              $this->_eventManager->dispatch('gbprimepay_before_barcode');
              $selected = $this->_config->setGBPMethod('selected_barcode');
              ...
              $purchase = array(
                  ...
                  "method" => 'gbprimepay_barcode',
                  "status" => 'active'
              );
              $save_purchase = $this->gbprimepayBarcode->_purchaseData($purchase);
              }
