...
class EventsBeforeQrcredit extends \GBPrimePay\Payments\Controller\Checkout
  {
      ...
      {
          try {
              $this->_eventManager->dispatch('gbprimepay_before_qrcredit');
              $selected = $this->_config->setGBPMethod('selected_qrcredit');
              ...
              $purchase = array(
                  ...
                  "method" => 'gbprimepay_qrcredit',
                  "status" => 'active'
              );
              $save_purchase = $this->gbprimepayQrcredit->_purchaseData($purchase);
              }
